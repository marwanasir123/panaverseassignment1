...
var array1 = ["marwa", "maha", "samen", "fatima", "rubina"];
//console.log(array1);
//question#12
//print message
var array1 = ["marwa", "maha", "samen", "fatima", "rubina"];
...
var guest_list = ["mahida", "maha", "marwa", "samen", "aiza", "husnain"];
...
//questin#18
//modify actual array
var modify = ["lahore", "france", "paris", "america", "islamabad"];
...
var language = ["english", "frasi", "urdu", "deutsch"];
var obj = [{
        company: "otto",
        year: 2000,
        color: "white"
...
var fav_faourit = ["banana", "apple", "graps"];
...
var person_name = ["maha", "admin", "fatima", "mahida", "aiza"];
...
var username1 = ["maha", "admin", "fatima", "mahida", "aiza"];
...
var current_user = ["husnain", "nasir", "ali", "asim", "subahat"];
var new_user = ["naisr", "kamran", "ali", "afaq", "asad"];
...
var pizza = ["pepperoni pizza", "mali boti pizza", "BBQ pizza"];
//for(var i=0; i<pizza.length; i++){
//console.log(`"i like ${pizza[i]}"`);}
//console.log("I really love pizza!");
//Question#35
//Think of at least three different animals that have a common characteristic. Store the names of these animals in a list, and then use a for loop to print out the name of each animal. 
var animal = ["Donkey", "Ox", "horse"];
...
function make_album(artistName, albumtitle, trackNumber) {
    var album2 = {
        artistName,
        albumtitle,
        trackNumber
...
var magician = ["Nasir", "Ali", "Afaq", "Subhan"];
...
function make_magicians(element) {
...
function make_magicians1(element) {
...
var sandwich = ["cheez", "spicy", "chicken"];
...
function car1(manufacturer, model, ...optional) {
    var fun = {
        manufacturer,
        model,
    };
